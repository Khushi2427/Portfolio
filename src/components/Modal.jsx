...
export default function Modal({isOpen, setIsOpen}) {
  return (
    <div className={`fixed z-10 inset-0 flex items-center justify-center px-4 bg-black/40 ${isOpen ? '' : 'hidden'}`}>
      <div className="about-section items-center justify-center flex flex-col md:flex-row rounded-lg grow relative max-w-[60rem] bg-[#191919] p-4 shadow-lg h-fit md:h-[700px]">
        ...
        <div className="about-me w-full flex items-center">
          <div className="about-me-text w-[98%] sm:w-[80%] my-0 mx-auto">
            ...
            I'm a MERN Stack Developer and Data Scientist, skilled at building dynamic websites and crafting machine learning solutions. Currently enhancing my expertise as a participant in the Amazon Future Engineers Bootcamp. Passionate about leveraging full-stack development and AI to create impactful digital experiences
            </p>
